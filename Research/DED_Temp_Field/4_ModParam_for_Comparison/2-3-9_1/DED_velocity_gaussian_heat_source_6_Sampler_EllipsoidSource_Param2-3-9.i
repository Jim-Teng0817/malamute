...
[Functions]
  [./path_x]
    type = ParsedFunction
    expression = 8.47e-3*t        # 2*cos(2.0*pi*t)   8.47e-3*t  6.35e-3*t
  [../]
  [./path_y]
    type = ParsedFunction
...
[Outputs]
  ...
  file_base = DED_Temp_Field_MALAMUTE_6_Sampler_4_Ellipsoid_TestTempField_Param2-3-9_1_55W_out
[]
