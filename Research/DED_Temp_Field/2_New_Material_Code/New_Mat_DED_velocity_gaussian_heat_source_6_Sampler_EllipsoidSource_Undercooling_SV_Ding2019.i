...
[Materials]
  ...
  [volumetric_heat]
    ...
    rx = 0.000375 # 0.000375   Ding2019, Figure 12, width ~= 520 mum => r = 0.5 mm = 0.0005
    ry = 0.000375 # 0.000375
    rz = 0.000375 # 0.000375
    power = 600 # 300 60 65 300 400  600
    efficiency = 0.3 # 0.3
    factor = 2
    function_x = path_x
    function_y = path_y
...
[Functions]
  [path_x]
    type = ParsedFunction
    expression = 10e-3*t # 2*cos(2.0*pi*t)  8.47e-3*t 100e-3*t 1000e-3*t  10e-3*t
  []
  [path_y]
    type = ParsedFunction
  ...
  [path_z]
    type = ParsedFunction
    expression = 5e-3 # 1 0.001 0.0012 0.0008  0.001
  []
...
[Executioner]
  ...
  start_time = 0.0
  end_time = 1.7 # 20  0.5 0.2 0.17 0.017  1.7
  dt = 0.1 # 1  0.01 0.001  0.1 
  dtmin = 1e-4
[]
...
[Outputs]
  ...
  file_base = 'outputs/SimplerVerification/Test_5_600W_3_Meltpool/Test_5_600W_Ding2019_3_ScanSpeedsmall100X_out'
