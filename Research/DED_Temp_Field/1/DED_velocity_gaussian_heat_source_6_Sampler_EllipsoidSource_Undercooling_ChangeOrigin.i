...
[BCs]
  # Convection 
  [convection_top]           # currently in use
    type = ConvectiveFluxFunction
    variable = temp
    boundary = SideSet_top
    T_infinity = 300.0
    coefficient = 10.0   #This will behave as described in the header of this file if this evaluates to 10     5~25 W/(m^2 * K)
  []
  ...
  [radiation_top]         # currently in use
...
[VectorPostprocessors]
  [point_value_vector_postprocessor_u]
    ...
    variable = 'temp undercooling_pn dendrite_growth_rate_pn'                       #  only for modified code for reading CSV File
    samples_file = data_points_4.csv        #  only for modified code for reading CSV File      data_points_test.csv
...
[Outputs]
  ...
  file_base = DED_Temp_Field_MALAMUTE_6_Sampler_2_Ellipsoid_60W_Undercooling_out
[]
