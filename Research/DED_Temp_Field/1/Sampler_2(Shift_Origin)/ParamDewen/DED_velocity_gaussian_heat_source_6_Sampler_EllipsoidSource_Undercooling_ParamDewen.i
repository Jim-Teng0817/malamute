...
[Materials]
  ...
  [volumetric_heat]
    ...
    rx = 0.00001   # 0.000375   100 mu m = 0.0001    #  Re-run needed
    ry = 0.00001   # 0.000375   100 mu m = 0.0001
    rz = 0.00001   # 0.000375   100 mu m = 0.0001
    power = 300    # 300 60 65
    efficiency = 0.36     # 0.3
    factor = 0.5   # 2
    function_x= path_x
  ...
  [heat]
    ...
    thermal_conductivity_temperature_function = 20     # W/m·K     25 
    temp = temp
  []
...
[Functions]
  [./path_x]
    type = ParsedFunction
    expression = 10.58e-3*t        # 2*cos(2.0*pi*t)     8.47e-3*t
  [../]
  [./path_y]
    type = ParsedFunction
...
[Outputs]
  ...
  file_base = DED_Temp_Field_MALAMUTE_6_Sampler_2_Ellipsoid_TestTempField_ParamDewen_300W_out
[]
