...
[Materials]
  ...
  [volumetric_heat]
    ...
    rx = 0.001875   # 0.000375
    ry = 0.001875   # 0.000375
    rz = 0.001875   # 0.000375
    power = 300   # 300 60
    efficiency = 0.3     # 0.3
    factor = 2
    function_x= path_x
...
[Outputs]
  ...
  file_base = DED_Temp_Field_MALAMUTE_6_Sampler_2_Ellipsoid_TestTempField_Finer1000times_300W_out
[]
