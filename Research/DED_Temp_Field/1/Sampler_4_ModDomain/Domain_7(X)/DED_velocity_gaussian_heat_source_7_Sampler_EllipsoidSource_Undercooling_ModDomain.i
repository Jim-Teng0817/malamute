[Mesh]
  [./DED_clad]
    ...
    file = DED_Temp_Field_Test_7_Mesh_1.e
  []
...
[Materials]
  ...
  [volumetric_heat]
    ...
    rx = 0.000375   # 0.000375     100 mu m = 0.0001 
    ry = 0.000375   # 0.000375     100 mu m = 0.0001 
    rz = 0.000375   # 0.000375     100 mu m = 0.0001 
    power = 65   # 300 60
    efficiency = 0.3     # 0.3
    factor = 2
    function_x= path_x
...
[Functions]
  ...
  [./path_y]
    type = ParsedFunction
    expression = 0.0005       # 2*sin(2.0*pi*t)   0
  [../]
  [./path_z]
    type = ParsedFunction
    expression = 0.0005   # 1
...
[VectorPostprocessors]
  [point_value_vector_postprocessor_u]
    ...
    samples_file = data_points_6.csv        #  only for modified code for reading CSV File      data_points_test.csv
...
[Outputs]
  ...
  file_base = DED_Temp_Field_MALAMUTE_7_Sampler_6_Ellipsoid_TestTempField_ModDomain_65W_out
[]
